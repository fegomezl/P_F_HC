...
Fit = sprintf(" x = E*IGamma_{(r,λ)}(t) \n E ≅ (%.3f ± %.3f) MJ \n r ≅ %.1f ± %.1f \n λ ≅ (%.2f ± %.2f) 1/s", E, E_err, r, r_err, lamda, lamda_err)
...
Fit = sprintf(" x = a*exp(b*x) \n a ≅ (%.4f ± %.4f) MJ \n b ≅ (%.5f ± %.5f) 1/s", a, a_err, b, b_err)

set obj 3 rect from graph 0.64, 0.80 to graph 1, 0.60 fc rgb "white" front
set lab 3 Fit at graph 0.64, 0.76 front

set title 'Energia vs tiempo'
set yl 'Energía (MJ)'
set o 'data/energy.pdf'
p[0:60][0:0.025] file u 1:2 w l ls 1 t 'Energía', Egamma(x) ls 2 t "Fit gamma", Eexp(x) ls 3 t "Fit exp"
